...
public class LittleEndian {
	...
	public static final int readInt(final byte[] ByteArray, final int index) {
		return (ByteArray[index] & 0xFF) | ((ByteArray[index + 1] & 0xFF) << 8)
				| ((ByteArray[index + 2] & 0xFF) << 16) | (ByteArray[index + 3] << 24);
	}
	 ...
	 *                  ByteArrayの範囲内に無い場合。
	 */
	public static final void writeShort(final byte[] ByteArray, final int index, final int value) {
	 ...
	 *                  ByteArrayの範囲内に無い場合。
	 */
	public static final void writeInt(final byte[] ByteArray, final int index, final int value) {
	 ...
	 *                  ByteArrayの範囲内に無い場合。
	 */
	public static final void writeLong(final byte[] ByteArray, final int index, final long value) {
