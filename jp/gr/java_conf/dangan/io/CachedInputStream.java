...
public class CachedInputStream extends InputStream {
	...
	public long skip(long length) throws IOException {
		...
		while (0 < length) {
			...
			final long skiplen = Math.min(length, (this.cacheLimit - this.cachePosition));
			length -= skiplen;
	...
	public int available() throws IOException {
		return this.cacheLimit - this.cachePosition + (this.in.available() / this.cache.length)
				* this.cache.length;//throws IOException
	}
