...
public class MsdosDate extends Date implements Cloneable {
	...
	public MsdosDate(final int time) {
		super((time >> 25 & 0x7F) + 80, (time >> 21 & 0x0F) - 1, time >> 16 & 0x1F,
				time >> 11 & 0x1F, time >> 5 & 0x3F, time << 1 & 0x3F); //deprecated
		this.checkRange();
	}
	...
	public void setMsdosTime(final int time) {
		final Date date = new Date((time >> 25 & 0x7F) + 80, (time >> 21 & 0x0F) - 1, time >> 16 & 0x1F,
				time >> 11 & 0x1F, time >> 5 & 0x3F, time << 1 & 0x3F); //deprecated
