...
public class PreLh1Decoder implements PreLzssDecoder {
	...
	public int readCode() throws IOException {
		...
		while (0 <= node) {
			node = this.huffman.childNode(node - (this.in.readBoolean() ? 1 : 0));//throws EOFException,IOException
		}
		final int code = ~node;
	...
	public int readOffset() throws IOException {
		...
		final int offHi = this.offHiTable[this.in.peekBits(this.offHiTableBits)]; //throws NotEnoughBitsException IOException
