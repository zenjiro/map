...
public class PreLzsDecoder implements PreLzssDecoder {
	...
	/** 一致長のビット数 */
	private static final int LengthBits = Bits
			.len(PreLzsDecoder.MaxMatch - PreLzsDecoder.Threshold);
	...
	public int readOffset() throws IOException {
		final int offset = (this.position - this.matchOffset - 1 - PreLzsDecoder.MaxMatch)
