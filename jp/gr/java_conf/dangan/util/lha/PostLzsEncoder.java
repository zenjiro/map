...
public class PostLzsEncoder implements PostLzssEncoder {
	...
	/** 一致長のビット数 */
	private static final int LengthBits = Bits.len(PostLzsEncoder.MaxMatch
			- PostLzsEncoder.Threshold);
	...
	public void writeOffset(final int offset) throws IOException {
		final int pos = (this.position - offset - 1 - PostLzsEncoder.MaxMatch)
