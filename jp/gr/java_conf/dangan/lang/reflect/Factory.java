...
public class Factory {
	...
	public static Object createInstance(final String classname, final Object[] args)
			throws InvocationTargetException, InstantiationException, ClassNotFoundException,
	 ...
	 * @throws NoSuchMethodException 
	 */
	public static Object createInstance(final Class type, Object[] args)
	 ...
	 *                 classname で示されるクラスが存在しない場合
	 */
	public static Constructor getConstructor(final String classname, final Object[] args, final boolean all)
			throws ClassNotFoundException {
	 ...
	 *         見つからなければ null。
	 */
	public static Constructor getConstructor(final Class type, final Object[] args, final boolean all) {
	 ...
	 *                 classname で示されるクラスが存在しない場合
	 */
	public static Constructor getMatchFullConstructor(final String classname, final Object[] args)
			throws ClassNotFoundException {
	 ...
	 *         見つからなければ null。
	 */
	public static Constructor getMatchFullConstructor(final Class type, final Object[] args) {
	 ...
	 *                 classname で示されるクラスが存在しない場合
	 */
	public static Constructor getMatchFullConstructor(final String classname, final Object[] args, final boolean all)
			throws ClassNotFoundException {
	 ...
	 *         見つからなければ null。
	 */
	public static Constructor getMatchFullConstructor(final Class type, final Object[] args, final boolean all) {
		final Constructor[] constructors = all ? type.getDeclaredConstructors() : type.getConstructors();
		for (int i = 0; i < constructors.length; i++)
			if (Type.matchFullAll(constructors[i].getParameterTypes(), args))
				return constructors[i];
