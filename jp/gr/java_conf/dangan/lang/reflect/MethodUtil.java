...
public class MethodUtil {
	 ...
	 */
	public static Object invoke(final Object obj, final String name, Object[] args)
	 ...
	 *                 インスタンスメソッドが見つからなかった場合。
	 */
	public static Object invokeStatic(final String classname, final String name, final Object[] args)
			throws ClassNotFoundException, InvocationTargetException, NoSuchMethodException {
		return MethodUtil.invokeStatic(Class.forName(classname), //throw ClassNotFoundException
				name, args); //throw InvocationTargetException, NoSuchMethodException
	}
	 ...
	 *                 インスタンスメソッドが見つからなかった場合。
	 */
	public static Object invokeStatic(final Class type, final String name, Object[] args)
			throws InvocationTargetException, NoSuchMethodException {
	 ...
	 */
	public static Method getInstanceMethod(final String classname, final String name, final Object[] args)
	 ...
	 *         見つからなければ null。
	 */
	public static Method getInstanceMethod(final Class type, final String name, final Object[] args) {
	 ...
	 *                 classname で示されるクラスが存在しない場合
	 */
	public static Method getInstanceMethod(final String classname, final String name, final Object[] args, final boolean all)
			throws ClassNotFoundException {
	 ...
	 *         見つからなければ null。
	 */
	public static Method getInstanceMethod(final Class type, final String name, final Object[] args, final boolean all) {
		final Method[] methods = all ? type.getDeclaredMethods() : type.getMethods();
		for (int i = 0; i < methods.length; i++)
			if (methods[i].getName().equals(name) && !Modifier.isStatic(methods[i].getModifiers())
	 ...
	 *                 classname で示されるクラスが存在しない場合
	 */
	public static Method getMatchFullInstanceMethod(final String classname, final String name, final Object[] args)
			throws ClassNotFoundException {
	 ...
	 *         見つからなければ null。
	 */
	public static Method getMatchFullInstanceMethod(final Class type, final String name, final Object[] args) {
	 ...
	 */
	public static Method getMatchFullInstanceMethod(final String classname, final String name, final Object[] args,
			final boolean all) throws ClassNotFoundException {
	 ...
	 *                 classname で示されるクラスが存在しない場合
	 */
	public static Method getStaticMethod(final String classname, final String name, final Object[] args)
			throws ClassNotFoundException {
	 ...
	 *         見つからなければ null。
	 */
	public static Method getStaticMethod(final Class type, final String name, final Object[] args) {
	 ...
	 *                 classname で示されるクラスが存在しない場合
	 */
	public static Method getStaticMethod(final String classname, final String name, final Object[] args, final boolean all)
			throws ClassNotFoundException {
	 ...
	 *         見つからなければ null。
	 */
	public static Method getStaticMethod(final Class type, final String name, final Object[] args, final boolean all) {
		final Method[] methods = all ? type.getDeclaredMethods() : type.getMethods();
		for (int i = 0; i < methods.length; i++)
			if (methods[i].getName().equals(name) && Modifier.isStatic(methods[i].getModifiers())
					&& Type.matchFullAll(methods[i].getParameterTypes(), args))
	 ...
	 *                 classname で示されるクラスが存在しない場合
	 */
	public static Method getMatchFullStaticMethod(final String classname, final String name, final Object[] args)
			throws ClassNotFoundException {
	 ...
	 *         見つからなければ null。
	 */
	public static Method getMatchFullStaticMethod(final Class type, final String name, final Object[] args) {
