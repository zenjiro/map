...
public class Type {
	 ...
	 *         違えば flase。
	 */
	public static boolean matchFullAll(final Class[] types, final Object[] args) {
	 ...
	 *         違えば flase。
	 */
	public static boolean matchRestrictAll(final Class[] types, final Object[] args) {
		boolean match = (types.length == args.length);
		for (int i = 0; i < types.length; i++)
	 ...
	 *         違えば flase。
	 */
	public static boolean matchAll(final Class[] types, final Object[] args) {
		boolean match = (types.length == args.length);
		for (int i = 0; i < types.length; i++)
	 ...
	 *         違えば false。
	 */
	public static boolean matchFull(final Class type, final Object obj) {
	 ...
	 *         違えば false。
	 */
	public static boolean matchRestrict(final Class type, final Object obj) {
		if (Type.matchFull(type, obj)) {
			return true;
		} else if ((type.equals(Byte.TYPE) || type.equals(Short.TYPE) || type.equals(Integer.TYPE)
				|| type.equals(Long.TYPE) || type.equals(Float.TYPE) || type.equals(Double.TYPE))
	 ...
	 *         違えば false。
	 */
	public static boolean match(final Class type, final Object obj) {
		...
		if (Type.matchRestrict(type, obj)) {
			...
			return true;
		} else if ((type.equals(Byte.class) || type.equals(Byte.TYPE) || type.equals(Short.class)
				|| type.equals(Short.TYPE) || type.equals(Integer.class)
				|| type.equals(Integer.TYPE) || type.equals(Long.class) || type.equals(Long.TYPE)
				|| type.equals(Float.class) || type.equals(Float.TYPE) || type.equals(Double.class) || type
				.equals(Double.TYPE))
				&& (obj instanceof Number || (obj != null && Type.isLongString(obj.toString())) || (obj != null && Type
						.isDoubleString(obj.toString())))) {
			return true;
		} else if ((type.equals(Boolean.TYPE) || type.equals(Boolean.class))
				&& ("TRUE".equalsIgnoreCase(str) || "FALSE".equalsIgnoreCase(str))) {
			return true;
		} else if ((type.equals(Character.class) || type.equals(Character.TYPE))
				&& obj instanceof String && (str.length() == 1 || Type.isUnicodeEscape(str))) {
			return true;
		} else {
			return false;
		}
	 ...
	 */
	public static Object[] parseAll(final Class[] types, final Object[] args) {
	 ...
	 *             変換しようとした場合。
	 */
	public static Object parse(final Class type, final Object obj) {
		final String str = (obj == null ? null : obj.toString());
		if (type.isInstance(obj)) {
			return obj;
			...
			return str;
				...
				|| type.equals(Float.class) || type.equals(Float.TYPE) || type.equals(Double.class) || type
				.equals(Double.TYPE))
				&& (obj instanceof Number || (obj != null && Type.isLongString(str)) || (obj != null && Type
						.isDoubleString(str)))) {
			Number num = null;
	 ...
	 */
	private static boolean isUnicodeEscape(final String str) {
		if (str.length() == 6 && str.startsWith("\\u") && Type.isHexadecimal(str.substring(2))) {
			return true;
		} else {
			return false;
		}
	 ...
	 *         違えば false。
	 */
	private static boolean isLongString(final String str) {
		try {
			Long.parseLong(str);
			return true;
		} catch (final NumberFormatException exception) {
		...
		if (str.startsWith("0x") && Type.isHexadecimal(str.substring(2))) {
			final BigInteger val = Type.parseHexadecimal(str.substring(2));
	 ...
	 *         違えば false。
	 */
	private static boolean isDoubleString(final String str) {
		try {
			final Double num = Double.valueOf(str);
			if (!num.isInfinite() || str.equals("Infinity") || str.equals("-Infinity"))
				return true;
			else
				return false;
		} catch (final NumberFormatException exception) {
	 ...
	 */
	private static BigInteger parseHexadecimal(final String str) {
