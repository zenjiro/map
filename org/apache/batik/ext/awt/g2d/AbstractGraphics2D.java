...
public abstract class AbstractGraphics2D extends Graphics2D implements Cloneable {
    ...
    public void drawRoundRect(final int x, final int y, final int width, final int height,
        ...
        final RoundRectangle2D rect = new RoundRectangle2D.Float(x, y, width, height, arcWidth, arcHeight);
        this.draw(rect);
    }
    ...
    public void drawArc(final int x, final int y, final int width, final int height,
        ...
        final Arc2D arc = new Arc2D.Float(x, y, width, height, startAngle, arcAngle, Arc2D.OPEN);
        this.draw(arc);
    }
    ...
    public void fillArc(final int x, final int y, final int width, final int height,
                        final int startAngle, final int arcAngle){
        final Arc2D arc = new Arc2D.Float(x, y, width, height, startAngle, arcAngle, Arc2D.PIE);
        this.fill(arc);
    }
    ...
    public boolean drawImage(final Image img, final int x, final int y,
        ...
        return this.drawImage(img, x, y, img.getWidth(null), img.getHeight(null),
                         bgcolor, observer);
    }
