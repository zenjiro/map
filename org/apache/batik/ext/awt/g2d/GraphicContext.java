 ...
 * @version $Id: GraphicContext.java,v 1.10 2005/04/02 14:26:09 deweese Exp $
 */
public class GraphicContext implements Cloneable{
    ...
    public void translate(final int x, final int y){
        if(x!=0 || y!=0){
            ...
            this.transformStack.addElement(TransformStackElement.createTranslateElement(x, y));
        }
    }
    ...
    public void translate(final double tx, final double ty){
        ...
        this.transformStack.addElement(TransformStackElement.createTranslateElement(tx, ty));
    }
    ...
    public void rotate(final double theta){
        ...
        this.transformStack.addElement(TransformStackElement.createRotateElement(theta));
    }
     ...
     */
    public void rotate(final double theta, double x, double y){
    ...
    public void scale(final double sx, final double sy){
        ...
        this.transformStack.addElement(TransformStackElement.createScaleElement(sx, sy));
    }
    ...
    public void shear(final double shx, final double shy){
        ...
        this.transformStack.addElement(TransformStackElement.createShearElement(shx, shy));
    }
    ...
    public void transform(final AffineTransform Tx){
        ...
        this.transformStack.addElement(TransformStackElement.createGeneralTransformElement(Tx));
    }
    ...
    public TransformStackElement[] getTransformStack(){
        ...
        this.transformStack.copyInto(stack);
        return stack;
    }
    ...
    public FontRenderContext getFontRenderContext(){
        ...
        if(this.hints.get(RenderingHints.KEY_FRACTIONALMETRICS)
           == RenderingHints.VALUE_FRACTIONALMETRICS_OFF)
            useFractionalMetrics = false;

        final FontRenderContext frc = new FontRenderContext(this.defaultTransform,
                                                      isAntialiased,
