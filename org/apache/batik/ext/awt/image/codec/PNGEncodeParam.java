...
public abstract class PNGEncodeParam implements ImageEncodeParam {
    ...
    public static class Gray extends PNGEncodeParam {
        ...
        public int getTransparentGray() {
            ...
            final int gray = this.transparency[0];
            return gray;
        }
    ...
    public static class RGB extends PNGEncodeParam {
        ...
        public void setTransparentRGB(final int[] transparentRGB) {
            this.transparency = (transparentRGB.clone());
            this.transparencySet = true;
        }
     ...
     */
    public void setChromaticity(final float whitePointX, final float whitePointY,
                                final float redX, final float redY,
                                final float greenX, final float greenY,
                                final float blueX, final float blueY) {
     ...
     * A convenience method that calls the array version.
     */
    public void setPhysicalDimension(final int xPixelsPerUnit,
                                     final int yPixelsPerUnit,
    ...
    public void setSuggestedPalette(final PNGSuggestedPaletteEntry[] palette) {
        this.suggestedPalette = (palette.clone());
    ...
    public synchronized void removeUnsafeToCopyPrivateChunks() {
        ...
        final int len = this.getNumPrivateChunks();
        for (int i = 0; i < len; i++) {
            final String type = this.getPrivateChunkType(i);
     ...
     *         filtered data.  */
    public int filterRow(final byte[] currRow,
                         final byte[] prevRow,
                         final byte[][] scratchRows,
