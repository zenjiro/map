 ...
 * @version $Id: SVGConvolveOp.java,v 1.11 2005/03/27 08:58:35 cam Exp $
...
public class SVGConvolveOp extends AbstractSVGFilterConverter {
    ...
    public SVGFilterDescriptor toSVG(final ConvolveOp convolveOp){
        ...
        SVGFilterDescriptor filterDesc =
            (SVGFilterDescriptor)this.descMap.get(convolveOp);
        ...
        if (filterDesc == null) {
            ...
            final StringBuffer kernelMatrixBuf = new StringBuffer();
            final float data[] = kernel.getKernelData(null);
            for(int i=0; i<data.length; i++){
                kernelMatrixBuf.append(this.doubleString(data[i]));
